...
export const tracks = [
  ...
  {
    heading: "Cryptography, Cybersecurity, and Network Security",
    by: [
  ...
  {
    heading: "Cloud Computing, IoT, and Edge Technologies",
    by: [
  ...
  {
    heading: "Digital Innovation, Transformation, and Applications",
    by: [
